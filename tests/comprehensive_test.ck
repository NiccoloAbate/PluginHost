...
// Raw MIDI
// Note On chan 1, key 60, vel 100
plugin.midiMsg(144, 60, 100);
...
if (numProgs > 0)
{
    ...
    0 => plugin.program;
    // getProgram
    <<< "Current Program index:", plugin.program() >>>;
}

// State
plugin.saveState("test_plugin_state");
plugin.loadState("test_plugin_state");
